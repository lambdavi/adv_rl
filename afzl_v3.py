...
class FailureZoneBuffer:
    """Memory buffer for storing and querying catastrophic failure states"""
...
if __name__ == "__main__":
    ...
    failure_buffer = FailureZoneBuffer(
    ...
    for global_step in range(args.total_timesteps):
        ...
        if global_step > args.learning_starts:
            ...
            with torch.no_grad():
                ...
                # AFZL: Add failure zone penalties to Q-targets
                if args.afzl_enabled and failure_buffer is not None:
            ...
            if global_step % args.policy_frequency == 0:
                for _ in range(args.policy_frequency):
                    ...
                    # AFZL: Add failure zone penalties to actor loss
